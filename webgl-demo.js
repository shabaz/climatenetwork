        ...
        if (arrayBuffer) {
            for (var texNum = 0; texNum < 809; texNum++)
            {
                ...
                for (var i = 0; i < 256; i++) {
                    for (var j = 0; j < 128; j++) {
                        if (i < 144 && j < 73) {
                            data[(j*256+i)*3+2] = arrayBuffer[j*144+i + texNum*(144*73)];
                            data[(j*256+i)*3+1] = arrayBuffer[j*144+i + texNum*(144*73)];
                            data[(j*256+i)*3+0] = arrayBuffer[j*144+i + texNum*(144*73)];
                        }
                    }
                }
